...
writer = tf.summary.FileWriter("./model/dddqn/1")
...
def predict_action(explore_start, explore_stop, decay_rate, decay_step, state, actions, force_best=False):
    ...
    if (explore_probability < exp_exp_tradeoff) or force_best:
        ...
        for episode in range(total_episodes):
            ...
            for test_episode in trange(test_episodes_per_epoch, leave=False):
                ...
                while not game.is_episode_finished():
                    ...
                    # Remember that stack frame function also call our preprocess function.
                    state, stacked_frames = stack_frames(stacked_frames, state, True)
                    action, explore_probability = predict_action(explore_start, explore_stop, decay_rate, decay_step, state, possible_actions, force_best=True)
